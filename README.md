...
dependencies {
    ...
    compile "com.chibatching.kotpref:initializer:2.1.1" // optional
    compile "com.chibatching.kotpref:enum-support:2.1.1" // optional
    compile "com.chibatching.kotpref:gson-support:2.1.1" // optional
}
```
